    ...
    <Card className='py-0 pl-[15px] flex flex-row justify-between rounded-[10px] h-[140px]'>
        <div className='flex flex-col justify-between text-wrap w-full'>
            <CardHeader className='pt-[20px] gap-y-[6px]'>
                <CardTitle className='!text-[16px] line-clamp-2'>Chocolate Caramel Milk Tea</CardTitle>
                <CardDescription className='!text-[14px] line-clamp-2'>Chocolate and caramel sirup with fresh milk tea.</CardDescription>
            </CardHeader>
            <CardFooter className=''>
            <p className='pb-[20px] text-[14px]'>$7.50</p>
            </CardFooter>
        </div>
