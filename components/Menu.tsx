      ...
      <div>
        {showAll ? (
          <div className="flex flex-col min-h-screen">
            <div className="sticky z-50 top-0 bg-white flex justify-between border-b-2 border-solid mb-[40px] py-[10px] px-[20px] sm:px-[96px]">
          ...
          <div>
            <div className="flex justify-between border-b-2 border-solid mb-[40px] py-[10px] px-[20px] sm:px-[96px]">
              <div className="text-[20px] flex gap-x-[40px]">
