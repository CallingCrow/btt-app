    ...
    <>
      ...
      {session ? (
        <div>
                  ...
                  <div className="flex flex-wrap gap-x-20">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={newItem.priceR}
                        onChange={(e) =>
                          setNewItem((prev) => ({
                            ...prev,
                            priceR: e.target.value
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        value={newItem.descriptionL}
                        onChange={(e) =>
                          setNewItem((prev) => ({
                            ...prev,
                            descriptionL: e.target.value,
                          }))
                        }
                      />
                    </div>
          ...
          <button onClick={logout} className="p-[0.5rem] bg-primary text-white">
            Log Out
          </button>
        </div>
      ) : (
